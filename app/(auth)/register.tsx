...
const ROLES: { value: UserRole; label: string; emoji: string }[] = [
  { value: 'student',  label: 'Студент',        emoji: '👨‍🎓' },
  { value: 'lecturer', label: 'Преподаватель',   emoji: '👨‍🏫' },
];
...
const styles = StyleSheet.create({
  ...
  card:                { backgroundColor: '#fff', padding: 30, borderRadius: 20, elevation: 5, shadowColor: '#000', shadowOpacity: 0.08, shadowRadius: 10 },
  ...
  roleLabel:           { fontSize: 16, fontWeight: '600', color: '#333', marginBottom: 12 },
  roleOptions:         { flexDirection: 'row', justifyContent: 'space-between', marginBottom: 20 },
  roleOption:          { flex: 1, backgroundColor: '#fff', borderWidth: 2, borderColor: '#E0E0E0', borderRadius: 12, padding: 12, marginHorizontal: 4, alignItems: 'center', justifyContent: 'center' },
  ...
  check:               { position: 'absolute', top: 8, right: 10, fontSize: 14, color: '#007AFF', fontWeight: 'bold' },
  button:              { backgroundColor: '#007AFF', padding: 16, borderRadius: 12, alignItems: 'center', marginTop: 4 },
