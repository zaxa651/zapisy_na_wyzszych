    ...
    const card = (
      ...
      >
        <View style={styles.courseInfo}>
          ...
          <LecturerBadge
            name={
              hasLecturer ? (lecturerInfo?.full_name ?? "Преподаватель") : null
            }
...
export default function CoursesScreen() {
  ...
  const handleProposeConfirm = useCallback(async () => {
    ...
    try {
      ...
      Alert.alert(
        "Готово",
        "Предложение отправлено на модерацию администратору",
      );
